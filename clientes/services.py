...
from clientes.repository import deletar_cliente_por_cpf, inserir_cliente
from clientes.repository import buscar_cliente_por_cpf
from clientes.repository import listar_todos_clientes
from clientes.repository import atualizar_cliente
